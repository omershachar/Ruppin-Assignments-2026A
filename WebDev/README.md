...
- **Course Name:** Developing Internet Systems - Client Side (פיתוח מערכות אינטרנט - צד לקוח)
- **Department:** Computer Science
- **Semester:** A, 2026 ('TASHPA')
- **Credits:** 3 (2 weekly hours)
...
* Understand the workflow of a Front-End Developer
* Build a full website including design, structure, and interactive behavior
* Develop self-learning skills using online resources (crucial for keeping up with rapid technological changes)

**Prerequisites:** Principles of Programming and C Language

---

## 🛠️ Tech Stack & Topics
* **HTML:** Structure, syntax, semantic elements, tables, forms
* **CSS:** Styling, Box Model, Flexbox, Grid, Responsive Design, Bootstrap
* **JavaScript:** Syntax, DOM manipulation, Event handling, ES6+ features (Arrow functions, Promises), Fetch API, Local Storage
...
| Week | Topic | Details |
| :--- | :--- | :--- |
| **1** | **Intro & HTML** | Course overview, Environment setup, Basic HTML structure/tags |
| **2** | **HTML Tables & CSS Intro** | Tables, Divs, Structural elements. Intro to CSS syntax and selectors |
| **3** | **CSS Layout** | CSS Box Model, Styling text/fonts, Class exercises |
...
| **11** | **Async JS (Part 1)** | Scope, Closure, Promises, Fetch intro |
| **12** | **Async JS (Part 2)** | Fetch API, HTML5 features |
| **13** | **Advanced Topics** | Advanced concepts and intelligent use of AI in development |
